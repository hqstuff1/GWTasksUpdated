...
public class TitledPanel extends Composite {
	...
	public PushButton addToolButton(String text, String title, ClickHandler handler) 
	{
		PushButton button = new PushButton(text, handler); 
		if (title != null) {
	...
	public PushButton addToolButton(Image image, ClickHandler handler) 
	{
		PushButton button = new PushButton(image, handler);
		addToolButton(button);
		return button;
	}
